...
const NavBar = () => {
  ...
  return (
   <motion.nav
      ...
      className={`w-full h-[8vh] flex items-center justify-center fixed ${isMobile ? "-bottom-[3%]" : "bottom-[0%]  px-2 py-2"}  left-0 z-[9999] mt-[1%]`}
    >
      <div
        className={`navbar ${
          isMobile ? 'w-[100%]' : 'w-[40%]'
      ...
      >
        <button
          onClick={() => navigate(-1)}
          aria-label="Go Back"
          className={`logo w-[8%] items-center  ${isMobile ? "h-[50%]" : "h-[100%] "} flex  justify-center bg-zinc-200 rounded-full shadow-2xl`}
        >
