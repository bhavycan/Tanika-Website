    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="sub-title mt-2 flex items-center text-left justify-start opacity-80">
        ...
        >
          ...
          >
            ...
            ></i>
            <h1 className="text-xl w-full font-semibold opacity-50">
              {" "}
              <a href="tel:+917383838877">+91 7383838877</a>
            </h1>
          </div>
          <div
            className={`part w-full flex items-center  ${
          ...
          >
            ...
            ></i>
            <h1 className="text-xl font-semibold opacity-50">
              {" "}
              <a href="mailto:bhavy203@gmail.com">Email Us</a>
            </h1>
          </div>
          <div
            className={`part w-full flex items-center  ${
