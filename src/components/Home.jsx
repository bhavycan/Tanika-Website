    ...
    >
      ...
      >
        <section
          ...
          className={`image w-full absolute z-10 overflow-hidden -top-10 ${
            isMobile ? "h-[120vh]" : "h-[150vh] "
          }`}
        >
          <img
            className={`${
              isMobile ? "object-cover object-[30%_75%]" : "object-cover"
        ...
        >
          ...
          >
            ...
            <h1 className="border-b-2 border-white py-0.5">associates LLP</h1>
          </div>
        ...
        <section className="center-text w-full mt-14 md:mt-12 relative z-10 text-center px-4">
          <div
            className={`title flex gap-2 md:gap-6 w-full ${
              isMobile
                ? "h-16 flex-col items-start"
                : "h-32 justify-center items-center"
            }`}
          >
            <motion.h1
              ...
              className={`${
                isMobile
                  ? "text-[5vw] tracking-tighter ml-6  font-serif"
                  : "text-[7vw] font-['font456']"
              }`}
            >
              We make
            </motion.h1>
            ...
            <motion.div
              className={`${
                isMobile
                  ? "w-[100%] h-[20vh] flex mt-3 items-center text-white justify-center"
                  : "text-[9vw] h-32 mb-6 "
              } tracking-tight relative font-["font123"]  text-[#2e2319]`}
            >
              {isMobile ? (
          ...
          <div
            className={`center-para w-full leading-tight ${
              isMobile
                ? "h-auto mt-[45%] text-sm text-center"
                : "h-28 leading-5"
            }`}
          >
            {(isMobile ? mobilepara : para).map((item, index) => (
              <h1
                ...
                className={`font-serif overflow-hidden ${
                  isMobile ? "text-[3vw]  w-full text-center" : ""
                }`}
              >
                <motion.span
                  initial={{ opacity: 0, y: 10 }}
        ...
        <footer
          className={`scroll w-full z-10 ${isMobile ? "mt-[10%]" : "mt-6"}`}
        >
