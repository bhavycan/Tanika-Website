...
const Home = () => {
  ...
  return (
    ...
    >
      {/* ✅ This is now your scroll container */}
      <div
      ...
      >
        ...
        >
          ...
          <div
            className={`logo absolute ${isMobile ? "left-1/2 -translate-x-1/2 top-12 w-24 h-24" : "left-[45%] top-10 w-32 h-32"}`}
          >
        ...
        <div className="center-text w-full mt-14 md:mt-12 relative z-10 text-center px-4">
          <div
            className={`title flex gap-2 md:gap-6 w-full ${isMobile ? "h-16 flex-col items-start" : "h-32 justify-center items-center"}`}
          >
            <motion.h1
        ...
        <div className={`scroll w-full z-10 ${isMobile ? "mt-[10%]" : "mt-6"}`}>
          ...
          >
            <i
              className={`ri-arrow-down-line ${isMobile ? "text-base z-30" : "text-[2vw]"} text-black`}
            ></i>
          </div>
        </div>
