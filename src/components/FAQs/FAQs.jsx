    ...
    <div className='w-screen min-[100vh] overflow-hidden mb-[5%]'>
      <NavBar />
        <motion.div className='title w-full flex overflow-hidden flex-col items-center justify-center h-[40vh]  px-2 py-3 mt-[5%]'> 
            ...
            className={` ${isMobile ? "text-[40vw] h-[50%] border-b-2 w-fit border-black" : "text-[18vw] w-full  h-[70%]"} flex items-center  justify-center  font-["font123"]`}>FAQ<motion.span 
            initial={{opacity : 0, scale : 2}}
            whileInView={{opacity : .8, scale :1            }}
             transition={{duration : 1 ,ease : "easeInOut", delay: .2}}
            className={`inline-block font-["font456"] ${isMobile ? "text-[25vw]" : "text-[12vw]"}  `}>s</motion.span></motion.h1>
